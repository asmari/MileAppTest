...
return [
    ...
    */
    'map'               => [
        ApiCode::SUCCESS_OK=>'api.success_ok',
        ApiCode::SUCCESS_CREATED=>'api.success_created',
        ApiCode::SUCCESS_NO_CONTENT=>'api.success_no_content',
        ApiCode::REDIRECTION_NOT_MODIFIED=>'api.redirection_not_modified',
        ApiCode::CLIENT_BAD_REQUEST=>'api.client_bad_request',
        ApiCode::CLIENT_UNAUTHORIZED=>'api.client_unauthorized',
        ApiCode::CLIENT_FORBIDDEN=>'api.client_forbidden',
        ApiCode::CLIENT_METHOD_NOT_ALLOWED=>'api.client_method_not_allowed',
        ApiCode::CLIENT_NOT_FOUND=>'api.client_not_found',
        ApiCode::CLIENT_CONFLICT=>'api.client_conflict',
        ApiCode::CLIENT_PRECONDITION_FAILED=>'api.client_precondition_failed',
        ApiCode::SERVER_ERROR=>'api.server_error',
    ],
